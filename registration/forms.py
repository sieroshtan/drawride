...
help_text = {
    "username": _("Username must contain only letters, numbers and underscores"),
    "password": _("Minimum 6 characters"),
}

error_mes = {
    "invalid_username": _("Enter a valid username"),
...
class RegistrationForm(forms.ModelForm):
    ...
    def save(self, *args, **kwargs):
        new_user = User.activation.create_inactive_user(
